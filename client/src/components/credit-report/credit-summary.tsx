...
export function CreditSummary({ 
  ...
  const { scrollToNext } = useSmoothScrollToNextCard();
        ...
        {showFullSummary && (
          <button
            onClick={() => {
              ...
              // Use shared hook for consistent scroll behavior
              setTimeout(() => {
        ...
        <div className="mt-4 flex justify-end">
          <Button
            onClick={() => {
              ...
              // Use standardized choreography: Green feedback → 500ms → Scroll to self → 500ms → Collapse (300ms) → 500ms → Scroll to next
              setTimeout(() => {
                requestAnimationFrame(() => {
                  scrollToNext();
                });
              ...
              // Collapse after scroll completes
              setTimeout(() => {
                setIsExpanded?.(false);
              }, 1300); // 500ms + 500ms + 300ms
            }}
            className={`${
